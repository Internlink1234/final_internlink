...
def generate_and_insert_candidates():
    ...
    # Sample data pools
    names = [
        "Alex Thompson", "Sarah Chen", "Michael O'Connor", "Priya Patel",
        "James Wilson", "Maria Garcia", "David Kim", "Emma Brown",
        "Hassan Ahmed", "Olivia Martinez"
    ]

    companies = [
        "Google", "Microsoft", "Amazon", "Apple", "Meta", "IBM",
        "Intel", "Adobe", "Salesforce", "Oracle"
    ]

    universities = [
        "Stanford University", "MIT", "Carnegie Mellon", "UC Berkeley",
        "Georgia Tech", "University of Michigan", "Caltech",
        "University of Illinois", "Cornell University", "Harvard University"
    ]
    ...
    for i in range(10):
        ...
        candidate = {
            ...
            "password": bcrypt.hashpw(f"password{i}123".encode("utf-8"), bcrypt.gensalt()) if i % 2 == 0 else None,
            ...
            "profile": {
                ...
                "education": {
                    ...
                    "major": "Computer Science" if i % 2 == 0 else "Business Administration",
                    "cgpa": f"{3.5 + (i/10):.2f}",
                    "startYear": 2019 + i,
                    "endYear": 2023 + i,
                    "year": 4,
                ...
                "experience": [
                    {
                        "company": companies[i],
                        "position": "Software Engineer" if i % 2 == 0 else "Product Manager",
                ...
                "tags": ["IT", "Marketing"] if i % 2 == 0 else ["Human Resources", "Sales"],
